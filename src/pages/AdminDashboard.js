...
export default function AdminDashboard(props) {
  ...
  const deleteCode = async (codeID) => {
    await Axios.delete(
      `https://api-noobegg.up.railway.app/api/deleteCode/${codeID}`
    );
    //await setCodes(null);
  };
  ...
  const updateAccount = async () => {
    ...
    let response = await Axios.put(
      "https://api-noobegg.up.railway.app/api/updateAccount",
      {
        userID: user.UserID,
        fName: fName,
        lName: lName,
    ...
    let tempUser = await Axios.get(
      `https://api-noobegg.up.railway.app/api/getUser/${user.UserID}`
    );
        ...
        {viewingOrder ? (
          ...
          <div>
            <ListGroup variant="flush">
              ...
              <h3>Add Item</h3>
              <ListGroup.Item>
                <Button href="/admin/additem">Add Item</Button>
              </ListGroup.Item>
              ...
              <ListGroup.Item>
                <DropdownButton variant="outline-dark" title="Sort">
                  ...
                  <Dropdown.Item onClick={() => sortByCustomer()}>
                    Sort by Customer
                  </Dropdown.Item>
                </DropdownButton>
              </ListGroup.Item>
                          ...
                          <tr key={order.OrderID}>
                            <td>
                              <button
                                ...
                                onClick={() => showOrder(order.OrderID)}
                              >
                                {order.OrderID}
                              </button>
                            </td>
                            ...
                            return (
                              <tr key={code.dCode}>
                                ...
                                <td>
                                  <Button
                                    variant="danger"
                                    onClick={() => clickedDelete(code.dCode)}
                                  >
                                    Delete
                                  </Button>
                                </td>
