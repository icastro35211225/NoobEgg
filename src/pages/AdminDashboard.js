...
export default function AdminDashboard(props) {
    ...
    const postCodes = async () => {
        await Axios.post('ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/addCode',
            {
                code: disCode,
                mult: mult
            });
    ...
    const deleteCode = async (codeID) => {
        await Axios.delete(`ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/deleteCode/${codeID}`);
        //await setCodes(null);
    }

    const updateAccount = async () => {
        let response = await Axios.put('ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/updateAccount',
            {
                userID: user.UserID,
                fName: fName,
                lName: lName,
        ...
        let tempUser = await Axios.get(`ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/getUser/${user.UserID}`);
    ...
    const getOrders = async () => {
        let tempOrders = await Axios.get('ec2-52-23-224-166.compute-1.amazonaws.com:3000/api/getAllOrders');
