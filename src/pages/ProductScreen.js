...
export default function ProductScreen(props) {
    ...
    const getProduct = async (ID) => {
        let tempProd = await Axios.post('https://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/getProduct', { id: ID });
    ...
    const updateProduct = async () => {
        let response = await Axios.put('https://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/updateProduct',
            {
    ...
    const deleteProduct = async () => {
        let response = await Axios.delete(`https://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/deleteProduct/${product.ProductID}`);
    }

    const deleteInstanceCart = async () => {
        let res = await Axios.delete(`https://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/delinstscart/${product.ProductID}`)
    }
    ...
    const postProd = async () => {
        let res = await Axios.post('https://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/addToCart',
            {
                userID: user.UserID,
