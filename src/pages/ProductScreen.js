...
export default function ProductScreen(props) {
  ...
  const getProduct = async (ID) => {
    let tempProd = await Axios.post(
      "https://api-noobegg.up.railway.app/api/getProduct",
      { id: ID }
    );
  ...
  const updateProduct = async () => {
    let response = await Axios.put(
      "https://api-noobegg.up.railway.app/api/updateProduct",
      {
  ...
  const deleteProduct = async () => {
    let response = await Axios.delete(
      `https://api-noobegg.up.railway.app/api/deleteProduct/${product.ProductID}`
    );
  };

  const deleteInstanceCart = async () => {
    let res = await Axios.delete(
      `https://api-noobegg.up.railway.app/api/delinstscart/${product.ProductID}`
    );
  };
        ...
        <div>
          ...
          {product === null ? (
            ...
            <div>
              <Row>
                <Col md={4}>
                  <img className="img-large" src={product.ProductImage}></img>
                </Col>
                <Col md={3}>
