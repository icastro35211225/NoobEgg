...
export default function ProductScreen(props) {
    ...
    const updateProduct = async () => {
        let response = await Axios.put('http://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/updateProduct',
            {
    ...
    const deleteProduct = async () => {
        let response = await Axios.delete(`http://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/deleteProduct/${product.ProductID}`);
    }

    const deleteInstanceCart = async () => {
        let res = await Axios.delete(`http://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/delinstscart/${product.ProductID}`)
    }
    ...
    const postProd = async () => {
        let res = await Axios.post('http://ec2-52-23-224-166.compute-1.amazonaws.com:3001/api/addToCart',
            {
                userID: user.UserID,
