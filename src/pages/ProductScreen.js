...
export default function ProductScreen(props) {
    ...
    const updateProduct = async () => {
        let response = await Axios.put('https://api-noobegg.up.railway.app/api/updateProduct',
            {
    ...
    const deleteProduct = async () => {
        let response = await Axios.delete(`https://api-noobegg.up.railway.app/api/deleteProduct/${product.ProductID}`);
    }

    const deleteInstanceCart = async () => {
        let res = await Axios.delete(`https://api-noobegg.up.railway.app/api/delinstscart/${product.ProductID}`)
    }
    ...
    const postProd = async () => {
        let res = await Axios.post('https://api-noobegg.up.railway.app/api/addToCart',
            {
                userID: user.UserID,
